...
const srcWheel = require('../resources/color-wheel.png')
const srcSlider = require('../resources/black-gradient.png')
const srcSliderRotated = require('../resources/black-gradient-rotated.png')
